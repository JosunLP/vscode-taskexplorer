...
export class TaskTreeManager implements ITeTreeManager, Disposable
{
    ...
    constructor(private readonly wrapper: TeWrapper)
    {
        ...
        this.disposables.push(
            ...
            registerCommand(Commands.AddRemoveCustomLabel, (taskItem: TaskItem) => this.addRemoveSpecialTaskLabel(taskItem), this),
            ...
            registerCommand(Commands.RunLastTask,  () => this.taskManager.runLastTask(this._treeBuilder.getTaskMap()), this),
