...
import { AntTaskProvider } from "./task/providers/ant";
import { HomeView } from "../webview/view/homeView";
import * as promiseUtils from "./utils/promiseUtils";
import { BashTaskProvider } from "./task/providers/bash";
import { GulpTaskProvider } from "./task/providers/gulp";
import { MakeTaskProvider } from "./task/providers/make";
import { RubyTaskProvider } from "./task/providers/ruby";
import { NsisTaskProvider } from "./task/providers/nsis";
import { PerlTaskProvider } from "./task/providers/perl";
import { WelcomePage } from "../webview/page/welcome";
import { TaskTreeManager } from "../tree/treeManager";
import { BatchTaskProvider } from "./task/providers/batch";
import { MavenTaskProvider } from "./task/providers/maven";
import { GruntTaskProvider } from "./task/providers/grunt";
import { GradleTaskProvider } from "./task/providers/gradle";
import { PipenvTaskProvider } from "./task/providers/pipenv";
import { PythonTaskProvider } from "./task/providers/python";
import { LicensePage } from "../webview/page/licensePage";
import { MonitorPage } from "../webview/page/monitorPage";
import { WebpackTaskProvider } from "./task/providers/webpack";
import { JenkinsTaskProvider } from "./task/providers/jenkins";
import { ComposerTaskProvider } from "./task/providers/composer";
import { TaskExplorerProvider } from "./task/providers/provider";
...
import { PowershellTaskProvider } from "./task/providers/powershell";
import { DisableTaskTypeCommand } from "./command/disableTaskType";
import { AppPublisherTaskProvider } from "./task/providers/appPublisher";
