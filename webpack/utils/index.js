...
const {/* START_CONST_DEFS */ isWebpackTarget, isWpBuildLogColor, isWpBuildLogTrueColor, isWpBuildRcBuildType, isWpBuildWebpackMode, WebpackTargets, WpBuildLogColors, WpBuildLogTrueColors, WpBuildRcBuildTypes, WpBuildWebpackModes /* END_CONST_DEFS */} = require("./constants");
...
module.exports = {
    ...
    /* START_CONST_DEFS */ isWebpackTarget, isWpBuildLogColor, isWpBuildLogTrueColor, isWpBuildRcBuildType, isWpBuildWebpackMode, WebpackTargets, WpBuildLogColors, WpBuildLogTrueColors, WpBuildRcBuildTypes, WpBuildWebpackModes /* END_CONST_DEFS */
};
