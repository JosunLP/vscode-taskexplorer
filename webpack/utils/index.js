...
const {
    ...
    findFiles,findFilesSync, uniq, WpBuildError, getExcludes
} = require("./utils");

module.exports = {
    apply, applyIf, asArray, capitalize, clone, execAsync, WpBuildApp, findFiles, findFilesSync, findTsConfig, getExcludes,
